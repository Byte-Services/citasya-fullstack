      ...
      {worker && (
        <div className="flex flex-col h-full px-1 sm:px-0">
          <div className="flex flex-col items-center mb-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-800 mb-1 break-words px-4">
              {worker.name}
            </h2>
          ...
          <div className="space-y-6 flex-1">
            <div className="bg-gray-50 rounded-2xl p-4 sm:p-5 border border-gray-100">
              ...
              <div className="space-y-3">
                <div className="flex items-start text-slate-600">
                  ...
                  <span className="break-all leading-6">{worker.email}</span>
                </div>
                <div className="flex items-start text-slate-600">
                  <PhoneIcon className="w-5 h-5 mr-3 text-slate-400" />
                  <span className="leading-6">{worker.phone}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-4 sm:p-5 border border-gray-100">
              ...
              <div className="flex items-start text-slate-600">
                ...
                <span className="leading-6 break-words">{worker.schedule}</span>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col sm:flex-row gap-3">
            <button
              type="button"
              onClick={onEdit}
              className="flex-1 flex items-center justify-center px-4 py-3 rounded-xl font-medium border border-primary text-primary hover:bg-primary/5 transition-colors"
            >
            ...
            <button
              type="button"
              onClick={onDelete}
              className="flex-1 flex items-center justify-center px-4 py-3 rounded-xl font-medium border border-rose-200 text-rose-600 hover:bg-rose-50 transition-colors"
            >
