...
export const ClientSegmentationChart: React.FC<ClientSegmentationChartProps> = ({ startDate, endDate }) => {
        ...
        const fetchChartData = async () => {
            ...
            try {
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_BACKEND_URL}/admin/dashboard/dashboard-client-segmentation?startDate=${startDate}&endDate=${endDate}`
                );
                ...
                console.error("Error al obtener datos del gráfico de segmentación:", error);
            } finally {
                setLoading(false);
            }
        };
    ...
    if (loading) {
        return (
            <div className="text-center py-8 text-neutral-500">
                Cargando gráfico de segmentación...
            </div>
        );
    }
        ...
        return (
            <div className="rounded-lg shadow-md" style={{ fontFamily: 'Poppins, sans-serif' }}>
                ...
                <div className="flex flex-col items-center p-6 text-neutral-500">
                    No hay datos de segmentación en este período.
                </div>
            </div>
        );
    }
